                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4 inspect-img">
                                ...
                                <p>Inspection report, Valuation report and due diligence</p>
                            </div>
                            <div className="col-md-8">
                                ...
                                <div className="row ml-4 mb-4">
                                    ...
                                    <div className="col-md-6 details align-self-center">
                                        <p>Make a deposit of ₦20,000 at your inspection center of choice.</p>
                                    </div>
                                </div>
                                ...
                                <div className="row ml-4 mb-4">
                                    ...
                                    <div className="col-md-6 details align-self-center">
                                        <p>Receive your inspection result within 2 hours later!</p>
                                    </div>
                                </div>
