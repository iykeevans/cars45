...
const Cardetails = (props) => {
      ...
      return (
        <a>
          <Image
            ...
            src={`https://buy.cars45.com/image/${images[i].images}`}
            layout="fill"
          />
        </a>
      );
  ...
  const confirmPayment = async () => {
    ...
    try {
      await payMoneyDown();
      let res = await postCall(
        endpoints.validateCarPayment,
        { ref: reference, url: window.location.href },
        {}
      );
      setLoading(false);
      if (
        res.data.data.message &&
        res.data.data.message === "Invalid Payment."
      ) {
  ...
  return (
    <HomeLayout footer="two" header="two">
      <Head>
        ...
        <meta
          name="description"
          content={`${carData?.make} ${carData?.model} ${carData?.year}`}
        />
      </Head>
      {loading && <Loading />}
      <button
                    ...
                    <nav aria-label="breadcrumb">
                      <ol className="breadcrumb">
                        ...
                        <li
                          ...
                          onClick={() => searchMake(carData?.make)}
                        >
                          <span href="/all-cars">{carData?.make}</span>
                        </li>
                        <li
                    ...
                    <div className="col-lg-7">
                      <Slider {...settings} ref={(c) => (slider = c)}>
                        {carData?.images?.map((img, index) => (
                          <div key={index}>
                            <Image
                              src={`https://buy.cars45.com/image/${img.images}`}
                              height={500}
                              width={646}
                              layout="responsive"
                            />
                      ...
                      <div className="prev-button-container">
                        ...
                        >
                          <img
                            src="https://storage.googleapis.com/cars45-web-bucket/prev.svg"
                            alt="prev"
                          />
                        </button>
                      </div>
                      <div className="next-button-container">
                        ...
                        >
                          <img
                            src="https://storage.googleapis.com/cars45-web-bucket/next.svg"
                            alt="next"
                          />
                        </button>
                      </div>
                    ...
                    <div className="col-lg-5 quick-details">
                      <div className="row quick-details-container mt-3">
                        <div className="col-5 col-md-5 align-self-center">
                          <h5>
                            {carData?.year} {carData?.make} {carData?.sku}
                          </h5>
                        </div>
                      ...
                      <div className="text-center">
                        <p className="simple-details">
                          {carData?.year} •{carData?.trim} •{carData?.mileage}{" "}
                          •₦{(carData?.price * 1)?.toLocaleString()}
                        </p>
                      </div>
                      <div className="recent">
                        <p>
                          {carData.viewed} buyers have viewed this vehicle in
                          the last 24 hours
                        </p>
                      </div>
                            ...
                            <div className="col-md-12 text-center">
                              <div className="content-container">
                                <form onSubmit={(e) => onPaysubmit(e)}>
                                  ...
                                  <p>
                                    Make a fully refundable{" "}
                                    <span style={{ color: "#ff9101" }}>
                                      deposit of
                                    </span>{" "}
                                    NGN{carData?.payNow.toLocaleString()} to
                                    hold this car
                                  </p>
                ...
                <div className="col-md-12">
                  ...
                  <div className="tab-content" id="myTabContent">
                    ...
                    >
                      <Caroverview
                        car={carData}
                        interestedInCar={window.location.href}
                      />
                    </div>
                          ...
                          <div className="row pt-3 car-info">
                            ...
                            <div className="col-md-12">
                              ...
                              <div className="text-left">
                                <p>
                                  Please enter your phone number in the
                                  remarks/transaction reference section on your
                                  internet banking/mobile banking while
                                  transferring the funds.
                                </p>

                                <p className="mb-3 orange-color">
                                  Bank : Providus
                                </p>
                                <p className="mb-3 orange-color">
                                  Account Name : C45/C45l-100015
                                </p>
                                <p className="mb-3 orange-color">
                                  Account Number : 9000010183
                                </p>

                                <p>
                                  Once the transfer has been completed, click
                                  the button below and call our customer care
                                  line on +2348096951860 to complete the
